...
//       <div className="grid grid-cols-3 gap-7 mt-4">
//         {courses.map((course) => (
//           <div key={course.id} className="w-full md:w-64 p-2 bg-white shadow-md hover:bg-Teal rounded-lg">
//             <Course {...course} />
//             <Link to={`/page/courses/${course.title}`}>
//             <button className="bg-Teal text-white py-2 px-4 rounded-md hover:bg-Teal-dark transition duration-300 w-full hover:text-yellow">
//                 Details</button>
//             </Link>
//           </div>
//         ))}
